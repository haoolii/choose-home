...
export default function App() {
  ...
  const colDefs = useMemo<ColDef<EmptyRoom>[]>(() => [
    { colId: '房屋編號', field: '房屋編號', headerName: '房屋編號', filter: false,                width: 100 },
    { colId: '房屋地址', field: '房屋地址', headerName: '房屋地址', filter: 'agTextColumnFilter', flex: 2 },
    {
      colId: '樓層',
      headerName: '樓層',
    ...
    { colId: '房型',         field: '房型',         headerName: '房型',         filter: SetFilter,            width: 110 },
    { colId: '坪數',         field: '坪數',         headerName: '坪數',         filter: SetFilter,            width: 90  },
    { colId: '棟別',         field: '棟別',         headerName: '棟別',         filter: SetFilter,            width: 90  },
    { colId: '戶別',         field: '戶別',         headerName: '戶別',         filter: SetFilter,            width: 90  },
    {
      colId: '租金',
      field: '租金(含管理費)',
      headerName: '租金(含管理費)',
    ...
    { colId: '備註', field: '備註', headerName: '備註', filter: SetFilter, flex: 1 },
    {
      colId: '備選',
      headerName: '備選',
      pinned: 'right',
